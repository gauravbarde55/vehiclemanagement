...
urlpatterns = [
    ...
    path('periodic.html', views.periodic, name="periodic"),
    path('ac.html', views.ac, name="ac"),
    path('caracc.html', views.caracc, name="caracc"),
    path('custom.html', views.custom, name="custom"),
    path('denting.html', views.denting, name="denting"),
    path('glass.html', views.glass, name="glass"),
    path('light.html', views.light, name="light"),
    path('tyre.html', views.tyre, name="tyre"),
    path('wash.html', views.wash, name="wash"),
