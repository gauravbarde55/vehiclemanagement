...
def periodic(request):
    return render(request, 'vehicle/periodic.html', {})
def ac(request):
    return render(request, 'vehicle/ac.html', {})
def caracc(request):
    return render(request, 'vehicle/caracc.html', {})
def custom(request):
    return render(request, 'vehicle/custom.html', {})
def denting(request):
    return render(request, 'vehicle/denting.html', {})
def glass(request):
    return render(request, 'vehicle/glass.html', {})
def light(request):
    return render(request, 'vehicle/light.html', {})
def tyre(request):
    return render(request, 'vehicle/tyre.html', {})
def wash(request):
    return render(request, 'vehicle/wash.html', {})
